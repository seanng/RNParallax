...
class RNParallax extends Component {
  ...
  getHeaderOpacity () {
    const headerScrollDistance = this.getHeaderScrollDistance()
    return this.state.scrollY.interpolate({
      inputRange: [-this.getExtraScrollHeight(), this.getHeaderMaxHeight() - this.props.titleShownMaxHeight, headerScrollDistance],
      outputRange: [0, 0, 1],
      extrapolate: 'clamp'
    })
  }
  ...
  getTitleTranslate () {
    ...
    return this.state.scrollY.interpolate({
      inputRange: [-this.getExtraScrollHeight(), this.getHeaderMaxHeight() - this.props.titleShownMaxHeight, headerScrollDistance],
      outputRange: [-this.getHeaderMinHeight(), -this.getHeaderMinHeight(), 0],
      extrapolate: 'clamp'
    })
  }
  ...
  renderHeaderBackground () {
    const { backgroundImage, backgroundColor, renderCover } = this.props
    const imageOpacity = this.getImageOpacity()
...
RNParallax.propTypes = {
  ...
  titleShownMaxHeight: PropTypes.number
}
...
RNParallax.defaultProps = {
  ...
  titleShownMaxHeight: DEFAULT_HEADER_MAX_HEIGHT
}
